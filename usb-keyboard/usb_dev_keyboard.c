...
// 
// Base file is part of revision 9453 of the EK-LM3S9D90 Firmware Package.

// Updated by Jeff Lawrence to cover Stellaris Launchpad - Updates
//	LED Changed to use onboard LED and use RED to reflect CAPS Lock State
// 	Button mapping changed to use SW1 on the stellaris (Left Button)
//  USB Peripheral and pins enabled (required on launchpad)
//
//*****************************************************************************
...
//! supporting the Human Interface Device class.  When the left push button is
    ...
    switch (ulEvent)
    {
        ...
        case USBD_HID_KEYB_EVENT_SET_LEDS:
        {
            ...
            ROM_GPIOPinWrite(GPIO_PORTF_BASE, GPIO_PIN_1,
                             (ulMsgData & HID_KEYB_CAPS_LOCK) ? GPIO_PIN_1 :
                             0);
